...
const tanamanRepositories = {
  ...
  getnotification: async()=>{
   ...
   var registrationToken = "fHihrlISUEQ:APA91bE9pGv_WQDEJtBf2Dg9z8kbkao8P2sKWcXzNxEXTpoOiWhTuBd--Rv8JtZ3ABOXpTftLCL8JyYAoQ2n8wpeh0qiOh_PY8svfEXQYX0Rc49Ia2l_rVG2vt3c71z2Cna6zcZSvpA2";
      var payload = {
        notification: {
          title:  " is abnormal !!",
  ...
  // streamUpdateData : async(kelembaban, ph, status,id) => {
    ...
    var volume = 0
    //jadi tanaman di jadwalkan untuk disiram pada jam 10.00 ketika tidak ada hujan, dan 17.00 ketika tidak ada hujan
    if ((timeHours == 9 && timeMinutes==01 && weatherPrec == 0) || (timeHours == 17 && timeMinutes==01 && weatherPrec == 0 ) || tmpKelembabanTanah<60 ) {
    ...
    if ((timeHours == 9 && timeMinutes==01 && weatherPrec == 0) || (timeHours == 17 && timeMinutes==01 && weatherPrec == 0 ) || tmpKelembabanTanah<60 ) {
    // if (tmpKelembabanTanah < 50 || tmpKelembabanTanah > 70 ) {
    ...
    // if (dataCuaca.forecast.forecastday[0].day.totalprecip_mm > 0) {
      ...
      // let tanamanInform = await Tanaman.findById(id)
      // let cuaca = await this.getWeather(tanamanInform.lokasiLahan);
    ...
    else if(timeHours == 2 && timeMinutes==52 && weatherPrec>0) {

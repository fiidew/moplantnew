...
String uri="/api/tanaman/5d1475f07b725313bc8da764/updatedata";
...
float getPh(int phPin)
{
        ...
        float Voltage = sensorValue* 5.0/1022;
...
//  metode sugeno
  float sangat_sedikit= 100;
  float sedikit=200;
  float agak_sedikit=300;
  float sedang=400;
  float agak_banyak=500;
  float banyak=600;
  float sangat_banyak=700;
